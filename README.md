...
# لیست امکانات ربات ورژن 1.2.2 ( در این اپدیت نیاز به تکرار مرحله 2 آموزش نصب میباشد )  
...
pkill -f "main.py"
```
# بروز رسانی ( درصورتی که از ورژن 1.2.0 به بالا استفاده میکنید قابل استفاده میباشد)
